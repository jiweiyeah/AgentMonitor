...
fn t_en(key: &str) -> &'static str {
    match key {
        ...
        "dashboard.total_cost" => "Σ cost",
        "dashboard.rate" => "Σ rate",
        ...
        "viewer.search.prompt" => "/",
        "viewer.search.placeholder" => "type to search…",
        "viewer.search.no_match" => "no match",
        "viewer.search.match_pos" => "match",
        "viewer.search.matches" => "matches",
        "footer.search" => "search",
        "footer.search_next_prev" => "next/prev match",
        ...
        "key_action.dashboard_cycle_cursor" => "Cycle dashboard panel",
        ...
        "key_action.sessions_toggle_star" => "Toggle session bookmark",
        ...
        "key_action.viewer_search_start" => "Search in viewer",
        "key_action.viewer_search_next" => "Next match",
        "key_action.viewer_search_prev" => "Previous match",
        "key_action.viewer_search_cancel" => "Cancel viewer search",
        "key_action.viewer_export_markdown" => "Export viewer to markdown",
        "key_action.viewer_copy_to_clipboard" => "Copy viewer to clipboard",
        ...
        "key_action.show_help" => "Show keyboard shortcuts",
        "settings.on" => "on",
        "settings.off" => "off",
        ...
        "help.dismiss_hint" => " press any key to close ",
...
fn t_zh(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "viewer.expanded" => "展开",
        "viewer.search.prompt" => "/",
        "viewer.search.placeholder" => "输入要搜索的内容…",
        "viewer.search.no_match" => "无匹配",
        "viewer.search.match_pos" => "匹配",
        "viewer.search.matches" => "处匹配",
        "footer.search" => "搜索",
        "footer.search_next_prev" => "上/下一处",
        ...
        "key_action.dashboard_cycle_cursor" => "切换仪表盘面板",
        ...
        "key_action.sessions_toggle_star" => "切换会话收藏",
        ...
        "key_action.viewer_search_start" => "在查看器中搜索",
        "key_action.viewer_search_next" => "下一个匹配",
        "key_action.viewer_search_prev" => "上一个匹配",
        "key_action.viewer_search_cancel" => "取消查看器搜索",
        "key_action.viewer_export_markdown" => "导出查看器为 markdown",
        "key_action.viewer_copy_to_clipboard" => "复制查看器到剪贴板",
